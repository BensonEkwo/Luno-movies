    ...
    <div className='flex flex-col items-center justify-center space-y-8 ' >
      ...
      <div className='grid grid-cols-3  md:grid-cols-4 gap-1 '>
        ...
        <div className='relative '>
          <img className='h-[160px] md:h-[265px] w-[338px]' src={drama} alt='drama'/>
        ...
        <div className='relative'>
          <img className='h-[160px] md:h-[265px] w-[338px]' src={documnetry} alt='documentry'/>
        ...
        <div className='relative'>
          <img className='h-[160px] md:h-[265px] w-[338px]' src={adventure} alt='adventure'/>
